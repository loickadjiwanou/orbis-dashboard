...
import { Mail, Lock, User, AlertCircle, Loader2, Wifi, Monitor, Shield } from 'lucide-react'
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-slate-50 px-6 py-12">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-slate-500">Join Orbis as an administrator</p>
          </div>
